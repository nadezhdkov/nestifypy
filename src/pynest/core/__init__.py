...
pynest.core
-----------
The heart of the Pynest framework.
...
class Logger:
    """Colored, timestamped logger for Pynest."""
...
class PynestError(Exception):
    """Base exception for all Pynest errors."""


class ConfigError(PynestError):
    """Raised when configuration is invalid or missing."""


class PluginError(PynestError):
    """Raised when a plugin fails to load or register."""


class ValidationError(PynestError):
    """Raised when a validation check fails."""


class RegistryError(PynestError):
