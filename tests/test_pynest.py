"""
tests/test_pynest.py
--------------------
Basic test suite for Pynest core modules.
Run with: pytest
"""
...
class TestRegistry:
    ...
    def test_duplicate_raises(self) -> None:
        from pynest.core import Registry, RegistryError
...
class TestDecorators:
    def test_debug_preserves_name(self) -> None:
        from pynest.decorators import debug
    ...
    def test_benchmark_returns_value(self) -> None:
        from pynest.decorators import benchmark
    ...
    def test_retry_succeeds_eventually(self) -> None:
        from pynest.decorators import retry
    ...
    def test_cache_memoizes(self) -> None:
        from pynest.decorators import cache
    ...
    def test_singleton(self) -> None:
        from pynest.decorators import singleton
    ...
    def test_event_and_emit(self) -> None:
        from pynest.decorators import event, emit, _EVENTS
    ...
    def test_validate_min(self) -> None:
        from pynest.decorators import validate
    ...
    def test_not_null(self) -> None:
        from pynest.decorators import not_null
    ...
    def test_safe_catches_error(self) -> None:
        from pynest.decorators import safe
    ...
    def test_startup_shutdown(self) -> None:
        from pynest.decorators import startup, shutdown, run_startup, run_shutdown
...
class TestVector2:
    def test_add(self) -> None:
        from pynest.types import Vector2
...
class TestUtils:
    def test_slugify(self) -> None:
        from pynest.utils import Strings
        assert Strings.slugify("Hello World!") == "hello-world"

    def test_clamp(self) -> None:
        from pynest.utils import Math
    ...
    def test_uuid(self) -> None:
        from pynest.utils import Random
        u1 = Random.uuid()
        u2 = Random.uuid()
        assert u1 != u2
        assert len(u1) == 36
    ...
    def test_email_validator(self) -> None:
        from pynest.utils import Validator
